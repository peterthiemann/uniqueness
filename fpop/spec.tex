...
\begin{mathpar}
  ...
  \inferrule[Var]{ \KENV; \TENV, \TENV' \models \MANY \\ \KENV \vdash t : k \\ \KENV \vdash k \le \ONE }{\KENV; \TENV, x:t, \TENV' \vdash x:t }
...
\begin{mathpar}
  \inferrule[V-Beta]{}{\APP{(\LAM x t e)}v \stepsto e[x \mapsto v]}

  \inferrule[T-Beta]{}{\TAPP{(\TLAM \TVAR k v)}t \stepsto v[\TVAR \mapsto t]}
