...
\begin{mathpar}
  \inferrule{
    ...
    A \vdash \REC{ \overline{a_i=e_i}} : \REC{ \overline{a_i :^{P_i} t_i}}
  }
  ...
  \inferrule{
    ...
    A \vdash \UPD {e_0}a{e_1} : \REC{ a:^P t \mid r}
  }
  \\
  \inferrule{
  }{
  ...
  \inferrule{
    ...
    A \vdash \LAM x t e : (t \to t')
  }
\end{mathpar}
Function closures have ``infinite'' splitting $(a :^P t)^*$ into $(a :^Q t)$.
\begin{itemize}
\item $P \le \{\READ\}$ propagate $Q = \READ$, no action required
