...
\item \resultFrame{}{}{_2}
  ...
  with $\VEnv'_2 =  (x\mapsto r_1) (x' \mapsto r_1')$:
  \begin{enumerate}[({A1-}1)]
  ...
  \item $\SE \vdash \VEnv_2 : \E_2$  by assumption; moreover, $\SE
    ...
    of the store typing for $\Loc$. Hence $\SE \vdash \VEnv_2' : \E_2 (x:\tau_1) (x':\tau_1')$.
  ...
  \item $\Reach\Store{\VEnv_2'} \subseteq \Perm'$ by assumption
  ...
  Hence the call to \lstinline{eval} yields
