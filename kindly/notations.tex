...
\newcommand\app[2]{(#1\ #2)}
\newcommand\borrow[2][\iota]{{\&}^{#1}#2}
\newcommand\borrowty[3][\iota]{{\&}^{#1}(#2,#3)}
\newcommand\region[2]{\ensuremath{\mathtt{region}_n\ (#1)\ \{#2\}}}
...
\newcommand\svar[3][\iota]{[#2 : #3]_{#1}}
\newcommand\bvar[2]{(#1 : #2)}
\newcommand\bshadow[2][\iota]{(#2)_{#1}}
\newcommand\bty[3]{(\T{#1} : #2 = #3)}
\newcommand\bineq[2]{(#1 \lk #2)}

\newcommand\esplit[2]{#1 \operatorname{\ltimes} #2}
\newcommand\tsplit[4]{#1 \Leftarrow #2 = #3 \ltimes #4}
\newcommand\lsplit[4]{#1 \vdash_e #2 = #3 \ltimes #4}
\newcommand\bsplit[4]{#1 \vdash_e #2 = #3 \ltimes #4}
\newcommand\tregion[4]{#1 \Leftarrow #3 \rightsquigarrow_n^{#2} #4}
