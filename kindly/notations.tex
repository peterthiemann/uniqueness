...
\newcommand\Rawloc[1]{\operatorname{rawloc} (#1)}
...
\newcommand\Writeable[2]{\operatorname{affine}_{#1} (#2)}
\newcommand\Linear[2]{\operatorname{linear}_{#1} (#2)}
\newcommand\Affine[2]{\operatorname{affine}_{#1} (#2)}
\newcommand\Crewrite{\leadsto}

\newcommand\REACH\Theta

\newcommand\MultiNumber[2]{\#(#1,#2)}
