...
\newcommand\ruleIAbs{%
  ...
  { \tvar,\kvar_\tvar,\kvar\text{ new}\\
    \inferW{\Sv}{(C',\unif')}
    {\E;\bvar{x}{\tvar};\bvar{\tvar}{\kvar_\tvar}}{e}{\tau} \\\\
    \addlin{ \Sv' = \Sv \Sdel{x} }\\
    D = C'\Cand
    \addlin{\Cleq{\Sv'}{\kvar} \Cand \Weaken_{x}(\Sv)} \\
    (C,\unif) = \normalize{D}{\unif'}
  }
...
\newcommand\ruleILet{%
  ...
  { \inferW{\Sv_1}{(C_1,\unif_1)}{\E}{e_1}{\tau_1} \\
    ...
    D =
    C'_1 \Cand C_2 \Cand
    \addlin{C_s \Cand \Weaken_{x}(\Sv_2)}  \\
    (C,\unif) = \normalize{D}{\unif'}\\
  }
...
\newcommand\ruleIMatch{%
  ...
  { \tvar,\kvar,\tvar',\kvar'\text{ new}\\
    ...
    \Cand \addlin{C_s \Cand \Weaken_{x,x'}(\Sv_2)} \\
    (C,\unif) = \normalize{D}{\unif'}\\
  }
  { \inferW{\addlin{\Sv}}{(C,\unif|_{\fv{\E}})}
