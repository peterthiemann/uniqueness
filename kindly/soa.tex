...
\begin{figure}[tp]
  \begin{center}
    ...
    \begin{tabular}{l|cccccccc}
      ...
      & UL & --- & \N & \N & \N & \N & \YC Coq & System F
      \\
      Alms~\citep{DBLP:conf/popl/TovP11}
      & UA & \N & \Y & \M & \Y & \NC Local & \N & ML \\
      Quill~\citep{DBLP:conf/icfp/Morris16}
      & UL & --- & \N & \N & \Y & \YC Principal & \MC Manual & Qualified types\\
      Linear Haskell~\citep{DBLP:journals/pacmpl/BernardyBNJS18}
      & UL & --- & \M & \N & \Y & \MC Non-principal & \MC Manual & Haskell \\
      Mezzo~\citep{DBLP:phd/hal/Protzenko14}
      & $\star$ & --- & \Y & \M & \Y & \N & \MC Manual & --- \\
      \hline
      Rust~\citep{rust}
      & UA & \Y & \Y & \Y & \M & \MC Local & \YC Coq & --- \\
      Vault~\citep{DBLP:conf/pldi/DeLineF01}/
      Plaid~\citep{DBLP:conf/oopsla/AldrichSSS09}
      & UA & --- & \Y & \Y & \Y & \N & \MC Manual & --- \\
      \hline
      \lang
      & UAL & \Y & \Y & \Y & \Y & \YC Principal & \MC Manual & ML/HM(X)
      \\
    \end{tabular}
  \end{center}
