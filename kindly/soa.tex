...
Each column indicates if a feature is present (\Y), absent (\N) or
partially supported (\M) such as when the feature is limited or can
...
\cref{identity}.
Inference is self-explanatory, formalization
refers to the existence of a formal semantics and type soundness proof. Basis is self-explanatory.
