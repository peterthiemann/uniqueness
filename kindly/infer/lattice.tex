\begin{minipage}{0.6\linewidth}
  \begin{mathpar}
    \inferrule{}{\kun_n \lk_\Lat \kaff_n}
    \and
    \inferrule{}{\kaff_n \lk_\Lat \klin_n}
    \\
    \inferrule{n \lk n'}{\kun_n \lk_\Lat \kun_{n'}}
    \and 
    \inferrule{n \lk n'}{\kaff_n \lk_\Lat \kaff_{n'}}
    \and 
    \inferrule{n \lk n'}{\klin_n \lk_\Lat \klin_{n'}}
  \end{mathpar}
\end{minipage}~
