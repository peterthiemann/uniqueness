\begin{mathpar}
  ...
  { 
    \inferS{C}
    {\E;\bvar{x}{\tau'}}{e}{\tau} \\
    \addlin{(\forall \bvar{x}{\schm} \in     \E|_{\fv e})~
    \entail C {k(\schm) \le k} }
  }
  { \inferS{C}{\E}
  ...
  { \inferS{C}{\E}{\borrow{x}}{\borrowty{\kvar}{\tau}} }
  \and
  \inferrule[Region]
  { \bvar x \tau \in \E \\
    \inferS{C}
    {(\E \Sdel x); \bvar{\borrow x}{\borrowty k\tau}}
    {e}
    {\tau} \\
