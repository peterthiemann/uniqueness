...
formulate constraint solving and simplification algorithms for $\CL$.
...
we write input parameters in \textbf{\textcolor{DarkSlateBlue}{bold
    blue}}. The remaining parameters are output parameters.
...
% However, we use an extension of \hmx with kind inference
% and affine types and borrows.
% We now show that \hmx's completeness and soundness theorems are still valid on
