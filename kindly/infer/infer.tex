...
%
Let $\mathcal C_{\mathcal L}$ the set of constraints in this lattice. We consider the
following base entailment rules in this system:
\begin{center}
  \begin{mathpar}
    \inferrule{l \leq l'}{\entail{}{\Cleq{l}{l'}}}
    \and
...
$C_0\in \mathcal C_{\mathcal L}$ is a set of constraints and $\unif_0$ is a substitution.
