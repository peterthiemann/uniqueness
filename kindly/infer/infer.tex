...
This section only states the theorems (and the necessary definitions).
Details and proofs are provided in \cref{appendix:constraints,appendix:infer}.

\subsubsection{Constraint system}

We requires three properties from our constraint solving algorithms: it should
compute normal firms, such normal forms should be unique, and the
system should be regular.
