...
We adapt and extend HM(X) existing rules to support kind inference,
...
in term of these new relations by using constraint entailment.
...
which return the necessary constraints.
