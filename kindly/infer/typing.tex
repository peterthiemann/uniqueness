\begin{mathpar}
  \inferrule[Var]
  { \bvar{x}{
      \forall \kvar_i \forall (\tvar_j:\kvar_j).\ \qual{C_x}{\tau}}
    \in \E \\
    (\kvar'_i),(\tvar'_j) \text{ new} \\
    \addlin{
      \inferK{(C_\tau,\unif_\tau)}{\E;\bvar{\tvar_j}{\kvar_j}}{\tau}{k_\tau}
    }\\
    D = C_x\Cand C_\tau \\
    \unif' =
  ...
  { \inferW{\addlin{\Sone{x}{\unif k_x}}}{(C,\unif|_{\fv{\E}})}{\E}{x}{\unif\tau} }
  \and
  \inferrule[Abs]
  { \tvar,\kvar_\tvar,\kvar\text{ new}\\
    \inferW{\Sv}{(C',\unif')}
    {\E;\bvar{x}{\alpha};\bvar{\tvar}{\kvar_\tvar}}{e}{\tau} \\\\
    \addlin{ \Sv' = \Sv \Sdel{x} }\\
  ...
  { \tvar,\kvar\text{ new}\\
    ...
    \Cand \addlin{\Cleq{\Sv_1 \Sinter \Sv_2}{\kun}} \\
    \unif' = \unif_1 \mostgeneral \unif_2 \\
    (C,\unif) = \normalize{D}{\unif'}\\
  }
  { \inferW{\addlin{\Sv_1 \Sunion \Sv_2}}{(C,\unif)}
  ...
  { \inferW{\Sv_1}{(C_1,\unif_1)}{\E}{e_1}{\tau_1} \\
    ...
    \unif' = \unif_1 \mostgeneral \unif_2 \\
    D =
    C'_1 \Cand C_2 \Cand \addlin{\Cleq{\Sv_1 \Sinter \Sv_2}{\kun}} \\
    (C,\unif) = \normalize{D}{\unif'}\\
  }
  { \inferW{\addlin{\Sv_1 \Sunion \Sv_2}}{(C,\unif|_{\fv{\E}})}
