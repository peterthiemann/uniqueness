...
them. This affinity shows up in the annotation of the second arrow in
...
\end{lstlisting}
as we would be using the affine closure twice.
...
hence the full truth is
$\forall\kappa\kappa_1\kappa_2\forall(\alpha:\kappa_1)\forall(\beta:\kappa_2)$,
which is only revealed if necessary for understanding the type. 
\begin{lstlisting}
