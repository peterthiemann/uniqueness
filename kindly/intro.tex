...
\item Our system supports exclusive and shared borrows, hence the
  need for affinity.
...
static type error.  To write to the file, we must take a (exclusive)
borrow \lstinline/&!h/ of the handle and pass it to the
\lstinline/write/ function. Exclusive borrows are classified as affine:
